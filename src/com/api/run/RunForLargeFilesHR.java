...
public class RunForLargeFilesHR {
	...
	public static void main(String[] args) throws IOException {
		...
		check.runHR(outputFile, inputFile, timeStamp, 1, keys,false,"rohit14331@gmail.com");
	}
	...
	public String runHRWithFile(String inFile, String outputFile,
			String timeStamp, int url, String[] keys, boolean sendEmail, String emailID) {
		// String configPath =
		// "/Users/Admin/Documents/DigitalIntern2015/workspace/GeoCodeAPI/etc/config.xml";
		// String config = "HumanResource";
		// String timeStamp = "2008";
		try {
			return runHR(outputFile, inFile, timeStamp, url, keys,sendEmail, emailID);
		} catch (IOException e) {
					...
					if (sendEmail) {
						if (count == 2000) {
							...
							SendEmail.sendEmailWithAttachment(s,
									...
									emailID, "Human Resources Archive",
									outputFile,
